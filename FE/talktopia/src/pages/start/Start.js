...
function Start(){
    ...
    return(
        <div>
            <h4>시작페이지</h4>
            <button className={`${style.button}`} onClick={()=>{navigate('/regist')}}>지금 바로 시작해보세요</button><br/>
            ...
            {/* <button className={`${style.button}`} onClick={()=>{navigate('/startreal')}}>이게 진짜 시작페이지</button> */}
